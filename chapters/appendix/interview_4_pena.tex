...
\begin{description}[leftmargin=0cm, labelsep=0.5cm]
    ...
    \item[\textbf{MUNTAABSKI FEDERICO:}] Joya, sigo yo, Santi, si querés. Bueno, voy a pasar a la siguiente pregunta. ¿Qué tan difícil resulta Y. Va, viste, vos mencionaste que justo en esa ocasión trabajabas con un equipo de shock, según entendí.
